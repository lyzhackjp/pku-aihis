"""Pull the <=10B classroom models into a running dedicated Ollama."""
from pathlib import Path
from urllib.request import Request,urlopen
import json,os,time
url=os.environ.get('OLLAMA_URL','http://127.0.0.1:11435')
for model in ['qwen3:4b-instruct-2507-q4_K_M','qwen3-embedding:0.6b','qwen3:4b','deepseek-r1:8b-0528-qwen3-q4_K_M','gemma3:4b','qwen3-vl:4b-instruct-q4_K_M']:
