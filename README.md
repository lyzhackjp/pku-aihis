...
《人工智能赋能历史研究与写作》的网页演示源码与协作仓库。本分支是29页“工具分类简化预览”，主线详细版保持33页，教案、完整OCR与私人原件保留在课程文件夹。

本分支将原D14—D20合为“知识库产品、搜索引擎、向量数据库”三页，尚未合并或发布到正式课堂。页面对应、预览和核验见[简化版说明](docs/week03/tool-families-preview.md)。
