...
实际运行时间：2026-09-22T20:34:18+0800。版本：1.19.1。查询：宗教。
...
```text
client.create_collection("week03", vectors_config=VectorParams(size=384, distance=Distance.COSINE))
client.upsert("week03", points=points)
client.query_points("week03", query=query_vector, limit=5)
```
...
```text
python local/runtime.py --tool qdrant
```
...
[Qdrant 原代码库](https://github.com/qdrant/qdrant)
